...
function roots_setup() {
  ...
  // Register wp_nav_menu() menus (//codex.wordpress.org/Function_Reference/register_nav_menus)
  ...
  // Add post thumbnails (//codex.wordpress.org/Post_Thumbnails)
  ...
  // Add post formats (//codex.wordpress.org/Post_Formats)
